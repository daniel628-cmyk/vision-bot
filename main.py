...
# የጥገና ሁነታ (ይህንን True በማድረግ ቦቱን ለጊዜው ማቆም ትችላለህ)
...
# --- MAINTENANCE CHECK ---
@bot.message_handler(func=lambda message: IS_MAINTENANCE)
def maintenance_mode(message):
    bot.reply_to(message, "🛠 **ቦቱ በአሁኑ ሰዓት ጥገና ላይ ነው!** 🚧\n\nለተፈጠረው መስተጓጎል ይቅርታ እንጠይቃለን። በቅርቡ በአዲስ አቅም ተመልሰን እንመጣለን! 🙏")
...
def send_welcome(message):
    welcome_text = (
        "✨ **ሰላም! ወደ Vision AI Bot በደህና መጡ!** ✨\n\n"
        "ምን ማድረግ እችላለሁ? 👇\n"
        "📝 **ጽሑፍ ለመተርጎም** - በቀጥታ ጽሁፉን ይላኩልኝ።\n"
        "📸 **ምስል ወደ ጽሑፍ ለመቀየር** - `/ocr` ብለው ይላኩልኝ።\n\n"
